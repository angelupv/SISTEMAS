					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Content styling">
								...
								<li class="nav-item"><a href="content_cards.html" class="nav-link">LISTADO</a></li>
								<li class="nav-item"><a href="content_cards_content.html" class="nav-link">REGISTRAR</a></li>
								<li class="nav-item"><a href="content_cards_layouts.html" class="nav-link">EDITAR</a></li>
						...
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Extra components">
								<li class="nav-item"><a href="extra_pnotify.html" class="nav-link">LISTADO</a></li>
								<li class="nav-item"><a href="extra_jgrowl_noty.html" class="nav-link">REGISTRAR</a></li>
								<li class="nav-item"><a href="extra_sweetalert.html" class="nav-link">EDITAR</a></li>
								<!--
								<li class="nav-item-divider"></li>
