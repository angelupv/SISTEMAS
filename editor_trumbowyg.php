		...
		<div class="content-wrapper">
			...
			<div class="content">
				...
				<div class="card">
					...
					<div class="card-body">
						<p class="mb-3">Trumbowyg editor comes with 10 optional plugins: <strong>base64</strong> - allows you to insert images inline as base64; <strong>clean paste</strong> - cleans up the php code before insert content into the editor; <strong>colors</strong> - adds foreground and background color selectors; <strong>emoji</strong> - allows you to insert some emojis in your editor; <strong>insert audio</strong> - inserts audio files; <strong>noembed</strong> - embed any content from a link; <strong>paste image</strong> - handles paste events; <strong>preformatted</strong> - wraps selected content in pre tag; <strong>template</strong> - manages custom php templates; <strong>upload</strong> - adds an upload front-end allowing users to upload an image with progress bar.</p>
						<form action="#">
							<div class="mb-3">
