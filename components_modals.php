					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Page layouts">
								<li class="nav-item"><a href="layout_fixed_navbar.php" class="nav-link">LISTADO</a></li>
								<li class="nav-item"><a href="layout_fixed_sidebar_custom.php" class="nav-link">REGISTRAR</a></li>
								<li class="nav-item"><a href="layout_fixed_sidebar_native.php" class="nav-link">EDITAR</a></li>
						...
						<table class="table">
							...
							<!--
								...
								<tr>
									...
									<td>Modal with <code>custom</code> color added to the modal header. To use, add any <a href="colors_primary.php">color class</a> from the color system to the <code>.modal-header</code> container</td>
								</tr>
								<tr>
									...
									<td>Modal dialog with <code>solid</code> custom background color. To use, add any <a href="colors_primary.php">color class</a> from the color system to the <code>.modal-content</code> container. Additionaly, you can also add a custom background color to the modal header</td>
								</tr>/-->
